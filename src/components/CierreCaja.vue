                    ...
                    <v-col cols="12" md="8" class="pa-0">
                        <v-row class="ma-0 pa-4 px-5" dense>
                            <v-col cols="12" style="border-bottom: 1px solid rgba(0,0,0,0.2)">
                                <v-card-title class="px-0" style="color:#2D2D8D;font-size:22px;">Cierre de
                                    Caja</v-card-title>
                            </v-col>
                                ...
                                <v-window v-model="tab">
                                    <v-window-item value="Guaraníes">
                                        <v-card-text class="divisas px-0 pt-10">
                                            ...
                                            <v-row class="ma-0"
                                                v-for="(value, cierre_caja_key_guaranies) in cierre_caja_filas_guaranies"
                                                :key="cierre_caja_key_guaranies">

                                                <v-col cols="12" md="3" class="pa-0 d-flex align-center">
                                                    <h style="font-size:20px; color:#2D2D8D;" class="mr-4 pb-4">Tengo </h>

                                                    <money3
                                                        v-model="cierre_caja_filas_guaranies[cierre_caja_key_guaranies].cierre_caja_guraranies_billetes"
                                                        v-bind="config" class="mt-n4 v-field__input v-field border-line">
                                                    </money3>
                                                </v-col>
                                                <v-col cols="12" md="4" class="pa-0 d-flex align-center">
                                                    <h style="font-size:20px; color:#2D2D8D;" class="mx-4 pb-4">Billetes de
                                                    </h>
                                                    <v-select variant="outlined"
                                                        v-model="cierre_caja_filas_guaranies[cierre_caja_key_guaranies].cierre_caja_guraranies_valor"
                                                        :items="tipo_billete" item-title="text" item-value="value" dense
                                                        class="mb-n1" />
                                                </v-col>
                                                <v-col cols="12" md="2" class="pa-0 d-flex align-center">
                                                    <h style="font-size:20px; color:#2D2D8D;" class="mx-4 pb-4">{{
                                                        cierre_caja_divisa }}</h>
                                                </v-col>
                                                <v-col cols="12" md="3" class="pa-0 d-flex align-center justify-end">
                                                    <h style="font-size:20px; color:#2D2D8D;" class="pb-4">Total = {{
                                                        ver_datos_guaranies }}
                                                        {{ cierre_caja_filas_guaranies[cierre_caja_key_guaranies].cierre_caja_guraranies_total }}
                                                    </h>
                                                </v-col>

                                            </v-row>
                                            <v-col cols="12">
                                                <v-btn class="btn-add-divisa" variant="outlined"
                                                    @click="agregar_guaranies_a_divisa()">
                                                    <v-icon>
                                                        mdi-plus-circle
                                                ...
                                                <v-btn class="cursor-pointer"
                                                    :disabled="cierre_caja_filas_guaranies.length >= maximo_filas_guaranies"
                                                ...
                                                <v-btn text class="ml-4 btn-delete-cierre_caja_divisa" color="error"
                                                    v-if="cierre_caja_filas_guaranies.length >= 2"
                                                    @click="eliminar_fila_guaranies(index_guaranies)">
                                                    <v-icon>
                                                        mdi-close-circle
                                                    </v-icon>
                                                </v-btn>
                                    ...
                                    <v-window-item value="Dólares">
                                        <v-card-text class="divisas px-0 pt-10">
                                            ...
                                            <v-row class="ma-0"
                                                v-for="(value, cierre_caja_key_dolares) in cierre_caja_filas_dolares"
                                                :key="cierre_caja_key_dolares">

                                                <v-col cols="12" md="3" class="pa-0 d-flex align-center">
                                                    <h style="font-size:20px; color:#2D2D8D;" class="mr-4 pb-4">Tengo </h>

                                                    <money3
                                                        v-model="cierre_caja_filas_dolares[cierre_caja_key_dolares].cierre_caja_dolares_billetes"
                                                        v-bind="config" class="mt-n4 v-field__input v-field border-line">
                                                    </money3>
                                                </v-col>
                                                <v-col cols="12" md="4" class="pa-0 d-flex align-center">
                                                    ...
                                                    <v-select variant="outlined"
                                                        v-model="cierre_caja_filas_dolares[cierre_caja_key_dolares].cierre_caja_dolares_valor"
                                                        :items="tipo_billete" item-title="text" item-value="value" dense
                                                        class="mb-n1" />
                                                </v-col>
                                                <v-col cols="12" md="2" class="pa-0 d-flex align-center">
                                                ...
                                                <v-col cols="12" md="3" class="pa-0 d-flex align-center justify-end">
                                                    <h style="font-size:20px; color:#2D2D8D;" class="pb-4">Total = {{
                                                        ver_datos_dolares }}
                                                        {{ cierre_caja_filas_dolares[cierre_caja_key_dolares].cierre_caja_dolares_total }}
                                                    </h>
                                                </v-col>
                                            ...
                                            <v-col cols="12">
                                                <v-btn class="btn-add-divisa" variant="outlined"
                                                    @click="agregar_dolares_a_divisa()">
                                                    <v-icon>
                                                        mdi-plus-circle
                                                    </v-icon> Añadir al total
                                                </v-btn>
                                                ...
                                                <v-btn class="cursor-pointer"
                                                    :disabled="cierre_caja_filas_dolares.length >= maximo_filas_dolares"
                                                ...
                                                <v-btn text class="ml-4 btn-delete-cierre_caja_divisa" color="error"
                                                    v-if="cierre_caja_filas_guaranies.length >= 2"
                                                    @click="eliminar_fila_dolares(index_dolares)">
                                                    <v-icon>
                                                        mdi-close-circle
                                                    </v-icon>
                                                </v-btn>
