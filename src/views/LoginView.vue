      ...
      <v-col cols="12" md="6" class="d-flex align-center justify-center">
        ...
        <v-col cols="12" md="6" class="text-center">
          ...
          <v-col cols="12" v-if="login">
            ...
            <v-text-field v-model="email_login" variant="underlined" label="Email" :rules="validar_correo" class="border-color">
          ...
          <v-col cols="12" v-if="restablecer">
            <v-form v-model="valid" ref="form" lazy-validation>
              ...
              <v-text-field variant="underlined" label="Email" :rules="validar_correo">
                <template #prepend-inner>
                  <v-icon class="custom-icon">mdi-email-outline</v-icon>
                </template>
              </v-text-field>
              ...
              <v-btn class="recuperar" variant="outlined"
                @click="btn_volver ? volver_login() : recuperar_contraseña()">{{ btn_volver ? 'Volver' : 'Recuperar Contraseña'}}</v-btn>
              <v-col>
